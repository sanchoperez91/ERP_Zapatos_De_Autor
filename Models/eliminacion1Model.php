...
class Datos
{
    // Método para ejecutar consultas de eliminación con parámetros preparados
    public function deleteData($sql, $typeParameters, ...$params)
    {
        try {
            ...
            $result = ["status" => "success", "message" => "Cliente eliminado con éxito."];
