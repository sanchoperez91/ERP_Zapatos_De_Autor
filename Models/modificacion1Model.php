...
class Datos
{
    // Método para ejecutar consultas de modificación con parámetros preparados
    public function updateData($sql, $typeParameters, ...$params)
    {
        try {
            ...
            $result = ["status" => "success", "message" => "Cliente modificado con éxito."];
